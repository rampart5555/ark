...
void ArkShadowTexture::setTextureUnit(unsigned int unit)
{
    _textureUnit = unit;
}

void ArkShadowTexture::init()
{
...
void ArkShadowTexture::update(osg::NodeVisitor& nv)
{
    _shadowedScene->osg::Group::traverse(nv);
}

void ArkShadowTexture::cull(osgUtil::CullVisitor& cv)
{
...
void ArkShadowTexture::cleanSceneGraph()
{
}
