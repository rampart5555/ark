...
static const char fragmentShaderSource_debugHUD[] =
    ...
    "   gl_FragColor = vec4( value, value, value, 0.4 ); \n"
    "} \n";

ArkShadowMap::ArkShadowMap():
    _baseTextureUnit(0),
...
void ArkShadowMap::setTextureUnit(unsigned int unit)
{
    _shadowTextureUnit = unit;
}

void ArkShadowMap::setPolygonOffset(const osg::Vec2& polyOffset)
{
    _polyOffset = polyOffset;
}

void ArkShadowMap::setAmbientBias(const osg::Vec2& ambientBias)
{
    _ambientBias = ambientBias;
    if (_ambientBiasUniform.valid()) _ambientBiasUniform->set(_ambientBias);
}

void ArkShadowMap::setTextureSize(const osg::Vec2s& textureSize)
{
    _textureSize = textureSize;
    dirty();
}

void ArkShadowMap::setLight(osg::Light* light)
{
    _light = light;
}


void ArkShadowMap::setLight(osg::LightSource* ls)
{
    _ls = ls;
    _light = _ls->getLight();
}

void ArkShadowMap::createUniforms()
{
    _uniformList.clear();
...
void ArkShadowMap::createShaders()
{
...
void ArkShadowMap::update(osg::NodeVisitor& nv)
{
    _shadowedScene->osg::Group::traverse(nv);
}

void ArkShadowMap::cull(osgUtil::CullVisitor& cv)
{
...
void ArkShadowMap::cleanSceneGraph()
{
}
...
////////////////////////////////////////////////////////////////////////////////
class ArkShadowMap::DrawableDrawWithDepthShadowComparisonOffCallback:
...
////////////////////////////////////////////////////////////////////////////////
osg::ref_ptr<osg::Camera> ArkShadowMap::makeDebugHUD()
{
